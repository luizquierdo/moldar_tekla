...
namespace moldar
{
    public class DiagonalesHorizontalDerIzq : DiagonalesVigueta, ComponentePanel
    {
        public DiagonalesHorizontalDerIzq(Beam muro, double dx, double dy)
            : base(muro, dx, dy)
        {
        }
        ...
        {
            return -(min.X + dx + NORMAL_DIAGONAL + 50.0 + DISTANCIA_A_TUBO);
        }
