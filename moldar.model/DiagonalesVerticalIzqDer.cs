...
namespace moldar
{
    public class DiagonalesVerticalIzqDer : DiagonalesVigueta, ComponentePanel
    {
        public DiagonalesVerticalIzqDer(Beam muro, double dx, double dy)
            : base(muro, dx, dy)
        {
        }
        ...
        {
            return max.Y - dy - DISTANCIA_A_TUBO;
        }
